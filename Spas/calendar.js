...
function scale_cal(start,days_num){
   ...
   if(days_num + start > 36){
      document.getElementById("calendar").style = "height: 560px;";
   }else{
      if(days_num + start < 30){
         document.getElementById("calendar").style = "height: 420px;";
      }else{
         document.getElementById("calendar").style = "height: 490px;";
      }
   }
}
